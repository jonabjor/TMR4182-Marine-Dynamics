...
def const_avg_acc(m, k, c, P, t, u0, udot0):
    ...
    # Time vector has constant spacing => compute h outside loop
    # iteration
    h = t[1] - t[0]

    # Computing the responses using constant average acc method
    # The left term from compendium eqn (3.80) is constant
    # and therefore computed outside iteration
